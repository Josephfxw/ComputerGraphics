...
enum {DUMMY, THRESHOLD, CONTRAST,QUANTIZATION,HISTOGRAMSTRETCHING,BLUR};
enum {RGB, R, G, B, GRAY};
...
MainWindow::createActions()
{
    ...
    m_actionHistogramStretching = new QAction("&HistogramStretching", this);
    m_actionHistogramStretching->setShortcut(tr("Ctrl+H"));
...
MainWindow::reset()
{
    ...
    m_imageFilterType[ CONTRAST ]->reset();
}
