...
QT_MOC_LITERAL(1, 9, 14), // "changeContrast"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 16) // "changeBrightness"

    },
    "Contrast\0changeContrast\0\0changeBrightness"
};
...
void Contrast::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeContrast((*reinterpret_cast< int(*)>(_a[1]))); break;
